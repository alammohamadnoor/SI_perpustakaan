...
public class pilih_anggota1 extends javax.swing.JFrame {
    ...
    private void tbpilih_anggMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbpilih_anggMouseClicked
        ...
        kmbl.a1 = tabmode.getValueAt(bar,0).toString();
        kmbl.a2 = tabmode.getValueAt (bar, 1).toString();
        //pnjm1.a5 = tabmode.getValueAt (bar, 4).toString();

        kmbl.anggotaterpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pilih_anggota1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pilih_anggota1().setVisible(true);
            }
        });
    }
