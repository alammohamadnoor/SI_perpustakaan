...
public class pilih_peminjaman extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmode;
    //public input_peminjaman pnjm1= null;
    public input_pengembalian piljam= null;
    /**
     * Creates new form pilih_peminjaman
     */
    public pilih_peminjaman() {
        initComponents();
         datatable();
    }
    
    protected void datatable(){
        Object [] Baris = {"No. Peminjaman","Tanggal Pinjam","Tanggal Kembali","ID Admin","ID Anggota","Kode Buku","Jumlah Pinjam","Status"};
            ...
            try{
                ...
                tbpilih_peminjaman.setModel(tabmode);
            } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tbpilih_peminjaman = new javax.swing.JTable();
        ...
        tbpilih_peminjaman.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbpilih_peminjaman.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tbpilih_peminjaman.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbpilih_peminjamanMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbpilih_peminjaman);
    ...
    private void tbpilih_peminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbpilih_peminjamanMouseClicked
        int bar = tbpilih_peminjaman.getSelectedRow();
        piljam.a1 = tabmode.getValueAt (bar, 0).toString();
        piljam.a2 = tabmode.getValueAt (bar, 1).toString();
        piljam.a3 = tabmode.getValueAt (bar, 2).toString();
        piljam.a4 = tabmode.getValueAt (bar, 3).toString();
        piljam.a5 = tabmode.getValueAt (bar, 4).toString();
        piljam.a6 = tabmode.getValueAt (bar, 5).toString();
        piljam.a7 = tabmode.getValueAt (bar, 6).toString();
        piljam.a8 = tabmode.getValueAt (bar, 7).toString();

        piljam.peminjamanterpilih();
        this.dispose();
    }//GEN-LAST:event_tbpilih_peminjamanMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pilih_peminjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pilih_peminjaman().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbpilih_peminjaman;
